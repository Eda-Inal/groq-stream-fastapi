...
This project was built step by step to understand how streaming, async database access, and clean backend architecture work together.

It is intentionally simple, explicit, and readable, making it suitable as a first serious backend project.
...
Persist prompt + response + metadata into PostgreSQL
...
Swagger UI does not display streaming responses correctly.
...
Database writes happen only after streaming completes

Async sessions are passed explicitly (no globals)
